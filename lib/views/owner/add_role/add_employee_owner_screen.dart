...
class AddEmployeeOwnerScreen extends StatefulWidget {
  final List<String> roles; // Accept roles dynamically

  const AddEmployeeOwnerScreen({super.key, required this.roles});

  @override
  _AddEmployeeOwnerScreenState createState() => _AddEmployeeOwnerScreenState();
}

class _AddEmployeeOwnerScreenState extends State<AddEmployeeOwnerScreen> {
